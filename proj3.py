...
for i in range(3, 17):
    ...
    # find correct data
    sceneriesData = soup.find("body").find('div', {'id': 'page-container'}).find(
        'div', {'id': 'left-area'}).find('ul', {'class': 'products columns-3'})
    ...
    myUrl = "https://store.flightsim.com/product-category/msfs/msfs-scenery/page/" + \
        str(i) + '/'
